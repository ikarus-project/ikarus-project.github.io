\hypertarget{a00338_source}{}\doxysection{vanishingstrain.\+hh}
\label{a00338_source}\index{vanishingstrain.hh@{vanishingstrain.hh}}
...
\DoxyCodeLine{15 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a00302}{ikarus/finiteelements/mechanics/materials/strainconversions.hh}}>}}
...
\DoxyCodeLine{98       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00421_ga2f675229501979101656ec4dee7764d5}{removeCol}}(stressesRed, \mbox{\hyperlink{a01638_a9a971e98d2d363a27c8736ef90656bb6}{fixedVoigtIndices}});}
...
\DoxyCodeLine{101       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(stressesRed, \textcolor{keyword}{false});}
\DoxyCodeLine{102     \}}
\DoxyCodeLine{103   \}}
\DoxyCodeLine{104 }
...
\DoxyCodeLine{117       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00426_af366ed9ed9329aecf202c8b170476efa}{reduceMatrix}}(C, \mbox{\hyperlink{a01638_a9a971e98d2d363a27c8736ef90656bb6}{fixedVoigtIndices}});}
\DoxyCodeLine{118     \textcolor{keywordflow}{else}}
\DoxyCodeLine{119       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(C);}
\DoxyCodeLine{120   \}}
\DoxyCodeLine{121 }
...
\DoxyCodeLine{149     \textcolor{keywordflow}{if} \textcolor{keyword}{constexpr} (\mbox{\hyperlink{a01638_a1f7a5f5b28a864dccd52725ef75fae1c}{strainTag}} == \mbox{\hyperlink{a00415_ggacef1e451de1a99845c59d7391064fb8fa9a932b3cb396238423eb2f33ec17d6aa}{StrainTags::linear}} or \mbox{\hyperlink{a01638_a1f7a5f5b28a864dccd52725ef75fae1c}{strainTag}} == \mbox{\hyperlink{a00415_ggacef1e451de1a99845c59d7391064fb8faca3f1e4bb21fd00a3d29c5d8aff8e11e}{StrainTags::greenLagrangian}}) \{}
...
\DoxyCodeLine{180 \textcolor{keyword}{auto} \mbox{\hyperlink{a00437_a03d13518406d1cd5bb2a34aca2f95f01}{makeVanishingStrain}}(MaterialImpl mat) \{}
...
\DoxyCodeLine{197 \textcolor{keyword}{auto} \mbox{\hyperlink{a00437_a5b428881c8ea5104acd909e769b7910b}{planeStrain}}(\textcolor{keyword}{const} MaterialImpl\& mat) \{}
\DoxyCodeLine{198   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00437_a03d13518406d1cd5bb2a34aca2f95f01}{makeVanishingStrain}}<\mbox{\hyperlink{a01630}{MatrixIndexPair}}\{2, 1\}, \mbox{\hyperlink{a01630}{MatrixIndexPair}}\{2, 0\}, \mbox{\hyperlink{a01630}{MatrixIndexPair}}\{2, 2\}>(mat);}
\DoxyCodeLine{199 \}}
