...
\DoxyCodeLine{17 }
\DoxyCodeLine{18 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a03121}{ikarus/utils/concepts.hh}}>}}
...
\DoxyCodeLine{89     \textcolor{keywordflow}{return} \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(E.derived(), \textcolor{keyword}{true});}
...
\DoxyCodeLine{150 \textcolor{keyword}{inline} \mbox{\hyperlink{a00426_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}} deviatoricStretches(\textcolor{keyword}{const} Vector\& lambda) \{}
...
\DoxyCodeLine{165 \textcolor{keyword}{inline} \mbox{\hyperlink{a00426_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}} invariants(\textcolor{keyword}{const} Vector\& lambda) \{}
