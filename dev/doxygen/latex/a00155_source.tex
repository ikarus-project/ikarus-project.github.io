...
\DoxyCodeLine{19 }
\DoxyCodeLine{20 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00439}{Ikarus::ResultEvaluators}} \{}
\DoxyCodeLine{21 }
...
\DoxyCodeLine{40     \textcolor{keyword}{auto} sigma = \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(resultArray, \textcolor{keyword}{false});}
\DoxyCodeLine{41 }
...
\DoxyCodeLine{77     \textcolor{keyword}{const} \textcolor{keyword}{auto} sigma = \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(resultArray, \textcolor{keyword}{false});}
...
\DoxyCodeLine{113     \textcolor{keyword}{auto} mat = \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(resultArray, \textcolor{keyword}{false});}
...
\DoxyCodeLine{172 \{}
\DoxyCodeLine{173   \mbox{\hyperlink{a01734_ab7bd86fc0638f4c9b779153c69d917d4}{PolarStress}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01930}{Dune::FieldVector<double, 2>}}\& origin)}
...
\DoxyCodeLine{190     \mbox{\hyperlink{a01930}{Dune::FieldVector<double, 2>}} posGlobal = fe.geometry().global(pos) -\/ origin\_;}
\DoxyCodeLine{191     \textcolor{keyword}{auto} theta                             = std::atan2(posGlobal[1], posGlobal[0]);}
\DoxyCodeLine{192 }
\DoxyCodeLine{193     \textcolor{keyword}{const} \textcolor{keyword}{auto} sigma = \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(resultArray, \textcolor{keyword}{false});}
...
\DoxyCodeLine{223   \mbox{\hyperlink{a01930}{Dune::FieldVector<double, 2>}} origin\_;}
\DoxyCodeLine{224 \};}
\DoxyCodeLine{225 }
