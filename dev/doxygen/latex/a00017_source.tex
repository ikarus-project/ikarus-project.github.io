...
\DoxyCodeLine{64 \textcolor{keyword}{requires}(std::convertible\_to<F, std::function<bool(\textcolor{keywordtype}{int}, \mbox{\hyperlink{a02274}{Dune::FieldVector<double, myDim>}} \&\&)>>)}
\DoxyCodeLine{65 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00531_ad8f6a5b5d6fb5a916fd5791adf5ef4d9}{forEachLagrangeNodePosition}}(\textcolor{keyword}{const} LV\& localView, F\&\& f) \{}
\DoxyCodeLine{66   \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a02435}{Concepts::LagrangeNode}}<std::remove\_cvref\_t<\textcolor{keyword}{decltype}(localView.tree().child(0))>>,}
...
\DoxyCodeLine{74     \textcolor{keyword}{auto} ithCoord = [\&i](\textcolor{keyword}{const} \mbox{\hyperlink{a02274}{Dune::FieldVector<double, myDim>}}\& x) \{ \textcolor{keywordflow}{return} x[i]; \};}
