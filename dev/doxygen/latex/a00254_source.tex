...
\DoxyCodeLine{26       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00422_ga4304655095296ce9283e012587817a51}{toVoigt}}(mat.derived(), strainlike);}
\DoxyCodeLine{27     \}}
\DoxyCodeLine{28   \};}
\DoxyCodeLine{29 }
...
\DoxyCodeLine{48       \textcolor{keywordflow}{return} \mbox{\hyperlink{a00422_gadc8e9e9f3838d0392a5fcf1e11374ee9}{fromVoigt}}(vec.derived(), strainlike);}
\DoxyCodeLine{49     \}}
\DoxyCodeLine{50   \};}
\DoxyCodeLine{51 }
...
\DoxyCodeLine{121 }
\DoxyCodeLine{124 }
\DoxyCodeLine{125   \mbox{\hyperlink{a00433_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(linearStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{126   \mbox{\hyperlink{a00433_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(PK2Stress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{127   \mbox{\hyperlink{a00433_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(cauchyStress, worldDim, worldDim, \textcolor{keyword}{false});}
\DoxyCodeLine{128 }
\DoxyCodeLine{129   \textcolor{comment}{// The following resulttypes are for reduced materials to obtain the full 3D stress state}}
\DoxyCodeLine{130   \mbox{\hyperlink{a00433_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(linearStressFull, 3, 3, \textcolor{keyword}{false});}
\DoxyCodeLine{131   \mbox{\hyperlink{a00433_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(PK2StressFull, 3, 3, \textcolor{keyword}{false});}
\DoxyCodeLine{132   \mbox{\hyperlink{a00433_a60454300a3ee8c6fdd19a7a62dce2202}{REGISTER\_SIMPLE\_SYMMETRIC\_RESULTTYPE}}(cauchyStressFull, 3, 3, \textcolor{keyword}{false});}
\DoxyCodeLine{133 }
\DoxyCodeLine{134   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(director, worldDim, 1);}
\DoxyCodeLine{135   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(magnetization, worldDim, 1);}
\DoxyCodeLine{136   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(gradientNormOfMagnetization, 1, 1);}
\DoxyCodeLine{137   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(vectorPotential, worldDim, 1);}
\DoxyCodeLine{138   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(divergenceOfVectorPotential, 1, 1);}
\DoxyCodeLine{139 }
\DoxyCodeLine{140   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(BField, worldDim, 1);}
\DoxyCodeLine{141   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(HField, worldDim, 1);}
\DoxyCodeLine{142 }
\DoxyCodeLine{143   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(cauchyAxialForce, 1, 1);}
\DoxyCodeLine{144   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(PK2AxialForce, 1, 1);}
\DoxyCodeLine{145   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(linearAxialForce, 1, 1);}
\DoxyCodeLine{146 }
\DoxyCodeLine{147   \mbox{\hyperlink{a00433_af279e0a4e5ede5f80277c45d542ae297}{REGISTER\_SIMPLE\_RESULTTYPE}}(customType, Eigen::Dynamic, Eigen::Dynamic);}
\DoxyCodeLine{148 \} \textcolor{comment}{// namespace ResultTypes}}
\DoxyCodeLine{149 }
\DoxyCodeLine{150 \textcolor{keyword}{enum class} \mbox{\hyperlink{a00426_acfb09bb7db104db62d3d1d2dc3e009b2}{ResultShape}}}
\DoxyCodeLine{151 \{}
\DoxyCodeLine{152   \mbox{\hyperlink{a00426_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{Vector}},}
\DoxyCodeLine{153   \mbox{\hyperlink{a00426_acfb09bb7db104db62d3d1d2dc3e009b2af53df0293e169f562bc1d9a20e1d2589}{Matrix}}}
\DoxyCodeLine{154 \};}
\DoxyCodeLine{155 }
...
\DoxyCodeLine{169   \textcolor{keyword}{static} \textcolor{keyword}{constexpr} \textcolor{keywordtype}{bool} storedValueIsVector       = storedResultShape == \mbox{\hyperlink{a00426_acfb09bb7db104db62d3d1d2dc3e009b2a57dea6f5039281b7fee517fc43bf3110}{ResultShape::Vector}};}
\DoxyCodeLine{170 }
...
\DoxyCodeLine{238 \textcolor{keyword}{auto} \mbox{\hyperlink{a00426_a38629395c2d43ba44328b01ce0c0daf3}{makeRT}}() \{}
...
\DoxyCodeLine{248 \textcolor{keyword}{auto} \mbox{\hyperlink{a00426_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}() \{}
\DoxyCodeLine{249   \textcolor{keywordflow}{return} \mbox{\hyperlink{a00426_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}(Impl::DummyRT<RT>\{\});}
\DoxyCodeLine{250 \}}
\DoxyCodeLine{251 }
...
\DoxyCodeLine{258 \textcolor{keyword}{constexpr} \textcolor{keyword}{static} \textcolor{keywordtype}{bool} \mbox{\hyperlink{a00426_aae9d6a05f2ca4f54c0524404e27e7ed1}{isSameResultType}} = std::is\_same\_v<Impl::DummyRT<RT1>, Impl::DummyRT<RT2>>;}
\DoxyCodeLine{259 }
...
\DoxyCodeLine{265   \textcolor{keyword}{struct }hasType<T, \mbox{\hyperlink{a00425}{std}}::tuple<Us...>> : std::disjunction<std::is\_same<T, Us>...>}
\DoxyCodeLine{266   \{}
\DoxyCodeLine{267   \};}
