\hypertarget{a00014_source}{}\doxysection{traversal.\+hh}
\label{a00014_source}\index{traversal.hh@{traversal.hh}}
...
\DoxyCodeLine{66   \textcolor{keyword}{static\_assert}(\mbox{\hyperlink{a02372}{Concepts::LagrangeNode}}<std::remove\_cvref\_t<\textcolor{keyword}{decltype}(localView.tree().child(0))>>,}
