\hypertarget{a00077_source}{}\doxysection{tensorproductquadrule.\+hh}
\label{a00077_source}\index{tensorproductquadrule.hh@{tensorproductquadrule.hh}}
...
\DoxyCodeLine{11 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00495}{Ikarus}} \{}
\DoxyCodeLine{12 }
\DoxyCodeLine{28 \textcolor{keyword}{template} <\textcolor{keyword}{class} BaseQuadrature, \textcolor{keyword}{class} Quadrature>}
\DoxyCodeLine{29 \textcolor{keyword}{auto} \mbox{\hyperlink{a00495_a839e2d8a648318c584c66024e62ddd91}{tensorProductQuadrature}}(\textcolor{keyword}{const} BaseQuadrature\& baseQuad, \textcolor{keyword}{const} Quadrature\& onedQuad) \{}
