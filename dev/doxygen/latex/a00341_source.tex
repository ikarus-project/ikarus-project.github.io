\hypertarget{a00341_source}{}\doxysection{eas2d.\+hh}
\label{a00341_source}\index{eas2d.hh@{eas2d.hh}}
...
\DoxyCodeLine{31   \textcolor{keyword}{static} \textcolor{keyword}{auto} \mbox{\hyperlink{a01446_a833af01a064166c8d39b1fa1b8d8c19a}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01930}{Dune::FieldVector<double, 2>}}\& \textcolor{comment}{/*quadPos*/}) \{ \textcolor{keywordflow}{return} MType::Zero(); \}}
\DoxyCodeLine{32 \};}
\DoxyCodeLine{33 }
...
\DoxyCodeLine{53       : geometry\_\{\mbox{\hyperlink{a00425}{std}}::make\_optional<GEO>(geometry)\},}
\DoxyCodeLine{54         T0InverseTransformed\_\{\mbox{\hyperlink{a00426_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry)\} \{\}}
\DoxyCodeLine{55 }
\DoxyCodeLine{56   \textcolor{keyword}{auto} \mbox{\hyperlink{a01450_a03e4a1b446ffd59d5e15c95fd7291b9f}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01930}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{92       : geometry\_\{\mbox{\hyperlink{a00425}{std}}::make\_optional<GEO>(geometry)\},}
\DoxyCodeLine{93         T0InverseTransformed\_\{\mbox{\hyperlink{a00426_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry)\} \{\}}
\DoxyCodeLine{94 }
\DoxyCodeLine{95   \textcolor{keyword}{auto} \mbox{\hyperlink{a01454_a2f5b495d9eabc2e3fcccfee1595e61eb}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01930}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
...
\DoxyCodeLine{132       : geometry\_\{\mbox{\hyperlink{a00425}{std}}::make\_optional<GEO>(geometry)\},}
\DoxyCodeLine{133         T0InverseTransformed\_\{\mbox{\hyperlink{a00426_a7a5b9f5e83f6918ca1726fb4316c3b86}{calcTransformationMatrix2D}}(geometry)\} \{\}}
\DoxyCodeLine{134 }
\DoxyCodeLine{135   \textcolor{keyword}{auto} \mbox{\hyperlink{a01458_adee00ef1f4bd1c7db877fb39626b4ed8}{calcM}}(\textcolor{keyword}{const} \mbox{\hyperlink{a01930}{Dune::FieldVector<double, 2>}}\& quadPos)\textcolor{keyword}{ const }\{}
