...
\DoxyCodeLine{20 }
\DoxyCodeLine{21 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00432}{Ikarus::Python}} \{}
\DoxyCodeLine{22 }
\DoxyCodeLine{50 \textcolor{keyword}{template} <\textcolor{keyword}{class }FE, \textcolor{keyword}{class}... options>}
\DoxyCodeLine{51 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00432_a0c58c17676c73945cb11eff8a80309ae}{registerCalculateAt}}(pybind11::handle scope, pybind11::class\_<FE, options...> cls, \textcolor{keyword}{auto} resultTypesTuple) \{}
\DoxyCodeLine{52   \textcolor{keyword}{using }Traits         = \textcolor{keyword}{typename} \mbox{\hyperlink{a01373_a70c7907448f7e13ff55b8fb123f3ee0c}{FE::Traits}};}
\DoxyCodeLine{53   \textcolor{keyword}{using }\mbox{\hyperlink{a01393}{FERequirements}} = \textcolor{keyword}{typename} \mbox{\hyperlink{a01657_a86c0fea1b37e487f3c78cde6facca9c3}{FE::Requirement}};}
\DoxyCodeLine{54   cls.def(}
\DoxyCodeLine{55       \textcolor{stringliteral}{"{}calculateAt"{}},}
\DoxyCodeLine{56       [\&](\mbox{\hyperlink{a01373}{FE}}\& self, \textcolor{keyword}{const} \mbox{\hyperlink{a01393}{FERequirements}}\& req, \textcolor{keyword}{const} \mbox{\hyperlink{a01917}{Dune::FieldVector<double, Traits::mydim>}}\& local,}
...
\DoxyCodeLine{61           \textcolor{keywordflow}{if} (resType == \mbox{\hyperlink{a00414_aef80b6b5b45dcfbea4f722f51a84f53f}{toString}}(i)) \{}
...
\DoxyCodeLine{71 \}}
\DoxyCodeLine{72 }
\DoxyCodeLine{86 \textcolor{keyword}{template} <\textcolor{keyword}{class }\mbox{\hyperlink{a01373}{FE}}, \textcolor{keyword}{class}... options>}
\DoxyCodeLine{87 \textcolor{keywordtype}{void} \mbox{\hyperlink{a00406_gac8bb4a818dee7342efbc5e174e35b840}{registerFE}}(pybind11::handle scope, pybind11::class\_<FE, options...> cls) \{}
\DoxyCodeLine{88   \textcolor{keyword}{using }BH          = \textcolor{keyword}{typename} \mbox{\hyperlink{a01373_a26398fefb73f4d51895e26152e368cf8}{FE::BasisHandler}};}
\DoxyCodeLine{89   \textcolor{keyword}{using }GridElement = \textcolor{keyword}{typename} \mbox{\hyperlink{a01373_ae329d665e853b0286679e97418d3acad}{FE::GridElement}};}
\DoxyCodeLine{90   \textcolor{keyword}{using }Requirement = \textcolor{keyword}{typename} \mbox{\hyperlink{a01657_a86c0fea1b37e487f3c78cde6facca9c3}{FE::Requirement}};}
\DoxyCodeLine{91   \textcolor{keyword}{using }FlatBasis   = \textcolor{keyword}{typename} \mbox{\hyperlink{a01429_a81feef959fedef62b2e1daabbd52b5f2}{FE::Traits::FlatBasis}};}
\DoxyCodeLine{92 }
\DoxyCodeLine{93   \textcolor{keywordtype}{int} index = 0;}
\DoxyCodeLine{94   cls.def(\mbox{\hyperlink{a00414_ac8243891c1b961e50a066140ab79a142}{pybind11::init}}([](\textcolor{keyword}{const} BH\& basisHandler, \textcolor{keyword}{typename} \mbox{\hyperlink{a01373_a327f5479545f9b5d615c07ce535b0007}{FE::PreTuple}} argsTuple) \{}
\DoxyCodeLine{95             \textcolor{keyword}{auto} unpackTuple = [\&]<\textcolor{keyword}{typename}... Arg>(Arg\&\&... args) \{}
\DoxyCodeLine{96               \textcolor{keywordflow}{return} \textcolor{keyword}{new} \mbox{\hyperlink{a01373}{FE}}(basisHandler, std::forward<Arg>(args)...);}
\DoxyCodeLine{97             \};}
\DoxyCodeLine{98             \textcolor{keywordflow}{return} std::apply(unpackTuple, argsTuple);}
\DoxyCodeLine{99           \}),}
\DoxyCodeLine{100           pybind11::keep\_alive<1, 2>());}
\DoxyCodeLine{101 }
\DoxyCodeLine{102   cls.def(\textcolor{stringliteral}{"{}bind"{}}, [](\mbox{\hyperlink{a01373}{FE}}\& self, \textcolor{keyword}{const} GridElement\& e) \{ self.\mbox{\hyperlink{a01373_a3a23d70495e802f44ba4b9923804dda0}{bind}}(e); \});}
\DoxyCodeLine{103   cls.def(\textcolor{stringliteral}{"{}calculateScalar"{}}, [](\mbox{\hyperlink{a01373}{FE}}\& self, \textcolor{keyword}{const} Requirement\& req, \mbox{\hyperlink{a00414_af6f894084edd9109762b86222995ef2a}{Ikarus::ScalarAffordance}} affordance) \{}
\DoxyCodeLine{104     \textcolor{keywordflow}{return} calculateScalar(self, req, affordance);}
\DoxyCodeLine{105   \});}
\DoxyCodeLine{106   cls.def(\textcolor{stringliteral}{"{}calculateVector"{}}, [](\mbox{\hyperlink{a01373}{FE}}\& self, \textcolor{keyword}{const} Requirement\& req, \mbox{\hyperlink{a00414_aab9e3e38507d1db7602bc750718c302a}{Ikarus::VectorAffordance}} affordance,}
...
\DoxyCodeLine{110       [](\mbox{\hyperlink{a01373}{FE}}\& self, \textcolor{keyword}{const} Requirement\& req, \mbox{\hyperlink{a00414_a390d5311179ec61d163a29c943b3d1a0}{Ikarus::MatrixAffordance}} affordance, Eigen::Ref<Eigen::MatrixXd> mat) \{}
...
\DoxyCodeLine{135       [](\mbox{\hyperlink{a01373}{FE}}\& self) -\/> LocalViewWrapper \{}
\DoxyCodeLine{136         \textcolor{keyword}{auto} lvWrapped = LocalViewWrapper(self.\mbox{\hyperlink{a01373_a1425316afd592244682b9ccc48cf59ef}{localView}}().globalBasis());}
...
\DoxyCodeLine{140         lvWrapped.base().bind(self.\mbox{\hyperlink{a01373_a1425316afd592244682b9ccc48cf59ef}{localView}}().element());}
\DoxyCodeLine{141         \textcolor{keywordflow}{return} lvWrapped;}
\DoxyCodeLine{142       \},}
\DoxyCodeLine{143       pybind11::keep\_alive<0, 1>());}
\DoxyCodeLine{144 }
\DoxyCodeLine{145   \mbox{\hyperlink{a00432_a0c58c17676c73945cb11eff8a80309ae}{registerCalculateAt}}(scope, cls, \textcolor{keyword}{typename} \mbox{\hyperlink{a01657_ada59c15363d83f6e635ecd6e1672d6a4}{FE::SupportedResultTypes}}());}
\DoxyCodeLine{146   \mbox{\hyperlink{a00432_a32c3989a8ef1dbc581313ef17a0c6f5b}{registerFERequirement}}(scope, cls);}
\DoxyCodeLine{147 \}}
\DoxyCodeLine{148 }
