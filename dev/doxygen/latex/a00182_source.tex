...
\DoxyCodeLine{31 \textcolor{keyword}{class }\mbox{\hyperlink{a01977}{ControlSubsamplingVertexVTKWriter}} : \textcolor{keyword}{public} \mbox{\hyperlink{a01989}{IObserver}}<ControlMessages>}
\DoxyCodeLine{32 \{}
...
\DoxyCodeLine{46   \mbox{\hyperlink{a01977_a1e07865751a32e0a1dd29e8f001babc3}{ControlSubsamplingVertexVTKWriter}}(\textcolor{keyword}{const} Basis\& \mbox{\hyperlink{a00443_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} Eigen::VectorXd\& sol, \textcolor{keywordtype}{int} refinementLevels = 0)}
\DoxyCodeLine{47       : basis\_\{\&\mbox{\hyperlink{a00443_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}\},}
\DoxyCodeLine{48         vtkWriter\_(\mbox{\hyperlink{a00443_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}.gridView(), \mbox{\hyperlink{a00437}{Dune}}::refinementLevels(refinementLevels)),}
\DoxyCodeLine{49         solution\_\{\&sol\} \{\}}
\DoxyCodeLine{50 }
\DoxyCodeLine{60   \textcolor{keyword}{auto} \mbox{\hyperlink{a01977_afec0c3fe2aa8cac3e9970d8c9720c219}{setFieldInfo}}(std::string\&\& name, Dune::VTK::FieldInfo::Type type, std::size\_t size,}
...
\DoxyCodeLine{64   \}}
\DoxyCodeLine{65 }
\DoxyCodeLine{71   \textcolor{keyword}{auto} \mbox{\hyperlink{a01977_a8061e516e4c6626a2f6ea160e692e4e1}{setFileNamePrefix}}(std::string\&\& name) \{ prefixString\_ = std::move(name); \}}
\DoxyCodeLine{72 }
\DoxyCodeLine{81   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01977_a72b675b3fb4b0b2989b315e2a0337e44}{updateImpl}}(\mbox{\hyperlink{a00408_ga35fa62fd2d4186a9750af3d0692f2893}{ControlMessages}} message) \textcolor{keyword}{final} \{}
...
\DoxyCodeLine{84       \textcolor{keywordflow}{case} \mbox{\hyperlink{a00408_gga35fa62fd2d4186a9750af3d0692f2893a0d30d757bf062e88728ebe7f8e2b2577}{ControlMessages::SOLUTION\_CHANGED}}: \{}
