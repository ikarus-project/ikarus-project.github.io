\hypertarget{a03106_source}{}\doxysection{io/vtkwriter.hh}
\label{a03106_source}\index{vtkwriter.hh@{vtkwriter.hh}}
...
\DoxyCodeLine{27 \textcolor{preprocessor}{\#include <\mbox{\hyperlink{a03121}{ikarus/utils/concepts.hh}}>}}
\DoxyCodeLine{28 }
\DoxyCodeLine{29 \textcolor{keyword}{namespace }\mbox{\hyperlink{a00440}{Ikarus::Vtk}} \{}
\DoxyCodeLine{30 }
...
\DoxyCodeLine{53   \textcolor{keyword}{struct }ResultContainer<\mbox{\hyperlink{a00449}{Dune}}::Functions::SubspaceBasis<RB, PP>>}
\DoxyCodeLine{54   \{}
...
\DoxyCodeLine{63   \textcolor{keyword}{struct }ResultContainerPre<\mbox{\hyperlink{a00449}{Dune}}::Functions::PowerPreBasis<IMS, SPB, size>>}
\DoxyCodeLine{64   \{}
...
\DoxyCodeLine{100       : Base(assembler-\/>gridView(), \mbox{\hyperlink{a00425}{std}}::forward<Args>(args)...),}
...
\DoxyCodeLine{111   \textcolor{keyword}{requires} \mbox{\hyperlink{a02110}{Concepts::DataCollector<std::decay\_t<DC\_>}}>}
...
\DoxyCodeLine{113       : Base(\mbox{\hyperlink{a00425}{std}}::forward<\mbox{\hyperlink{a00425}{std}}::decay\_t<DC\_>>(dc), \mbox{\hyperlink{a00425}{std}}::forward<Args>(args)...),}
\DoxyCodeLine{114         assembler\_(assembler) \{\}}
\DoxyCodeLine{115 }
\DoxyCodeLine{123   \textcolor{keyword}{template} <\textcolor{keyword}{typename} RF>}
\DoxyCodeLine{124   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01762_a658290b81fbe3d75d228ea393f5a6d47}{addResultFunction}}(RF\&\& resultFunction, \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273b}{DataTag}} dataTag = \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba68cd52d11d0547e9fa755ed70680591b}{DataTag::asPointData}}) \{}
\DoxyCodeLine{125     \textcolor{keywordflow}{if} (dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba358ac8d081a81d2a224773e362f76546}{DataTag::asCellData}} or dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273baaebbd52cccfb094252aee95b0cffe926}{DataTag::asCellAndPointData}})}
\DoxyCodeLine{126       Base::addCellData(std::forward<RF>(resultFunction));}
\DoxyCodeLine{127     \textcolor{keywordflow}{if} (dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba68cd52d11d0547e9fa755ed70680591b}{DataTag::asPointData}} or dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273baaebbd52cccfb094252aee95b0cffe926}{DataTag::asCellAndPointData}})}
...
\DoxyCodeLine{138   \textcolor{keyword}{requires}(\mbox{\hyperlink{a02105}{Concepts::ResultType<RT>}})}
\DoxyCodeLine{139   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01762_a80776ad077f50b77de658392cb8736fe}{addResult}}(\mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273b}{DataTag}} dataTag = \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba68cd52d11d0547e9fa755ed70680591b}{DataTag::asPointData}}, UserFunction\&\& userFunction = \{\}) \{}
...
\DoxyCodeLine{142   \}}
\DoxyCodeLine{143 }
\DoxyCodeLine{149   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01762_a1e3b740ff000dacda0ade44cc0646d9d}{addAllResults}}(\mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273b}{DataTag}} dataTag = \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba68cd52d11d0547e9fa755ed70680591b}{DataTag::asPointData}}) \{}
...
\DoxyCodeLine{169   \textcolor{keywordtype}{void} \mbox{\hyperlink{a01762_a40effe127a60fe7ae01bb7511a581d08}{addInterpolation}}(R\&\& vals, \textcolor{keyword}{const} Basis\& \mbox{\hyperlink{a00455_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, \textcolor{keyword}{const} std::string\& name, \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273b}{DataTag}} dataTag = \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba68cd52d11d0547e9fa755ed70680591b}{DataTag::asPointData}}) \{}
\DoxyCodeLine{170     \textcolor{keyword}{using }Container = Impl::ResultContainer\_t<Basis>;}
\DoxyCodeLine{171 }
\DoxyCodeLine{172     \textcolor{keyword}{auto} gridFunction = Dune::Functions::makeDiscreteGlobalBasisFunction<Container>(\mbox{\hyperlink{a00455_a0f9f04fa9d98e890cb6d4fe62ff889a4}{basis}}, std::forward<R>(vals));}
\DoxyCodeLine{173     \textcolor{keyword}{auto} fieldInfo    = Dune::Vtk::FieldInfo(name, Impl::sizeOfContainer<Container>);}
\DoxyCodeLine{174 }
\DoxyCodeLine{175     \textcolor{keywordflow}{if} (dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba358ac8d081a81d2a224773e362f76546}{DataTag::asCellData}} or dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273baaebbd52cccfb094252aee95b0cffe926}{DataTag::asCellAndPointData}})}
\DoxyCodeLine{176       Base::addCellData(std::move(gridFunction), fieldInfo);}
\DoxyCodeLine{177     \textcolor{keywordflow}{if} (dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273ba68cd52d11d0547e9fa755ed70680591b}{DataTag::asPointData}} or dataTag == \mbox{\hyperlink{a00440_af59748ac04116ae85cd64ea8675d273baaebbd52cccfb094252aee95b0cffe926}{DataTag::asCellAndPointData}})}
...
\DoxyCodeLine{199 \textcolor{keyword}{struct }\mbox{\hyperlink{a01766}{IsStructured}}<\mbox{\hyperlink{a00449}{Dune}}::YaspGrid<dim, Coordinates>> : std::true\_type}
\DoxyCodeLine{200 \{}
\DoxyCodeLine{201 \};}
\DoxyCodeLine{202 }
\DoxyCodeLine{208 \textcolor{keyword}{template} <\textcolor{keyword}{typename} GV>}
\DoxyCodeLine{209 \textcolor{keyword}{requires} \mbox{\hyperlink{a02111}{Concepts::GridView<GV>}}}
...
\DoxyCodeLine{224 \textcolor{keyword}{requires}(\mbox{\hyperlink{a02106}{Ikarus::Concepts::FlatAssembler<AS>}})}
\DoxyCodeLine{225 \mbox{\hyperlink{a00440_a6b54a4966e54b45e51358c7b7877a5b5}{Writer}}(std::shared\_ptr<AS>,}
...
\DoxyCodeLine{230 \textcolor{keyword}{requires}(\mbox{\hyperlink{a02106}{Ikarus::Concepts::FlatAssembler<AS>}})}
\DoxyCodeLine{231 \mbox{\hyperlink{a00440_a6b54a4966e54b45e51358c7b7877a5b5}{Writer}}(std::shared\_ptr<AS>, DC\&\&, Args...)}
